...
class Items extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    double cantainerPadding = 45;
    double containerBorderRadius = 10;
    return Column(
      children: <Widget>[
        Container(
          padding: EdgeInsets.only(
              left: leftAligned ? 0 : cantainerPadding,
              right: leftAligned ? cantainerPadding : 0),
          child: Column(
            children: <Widget>[
              Container(
      ...
      child: ListView(
        ...
        children: <Widget>[
          CategoryListItem(
            ...
            categoryName: 'Donimos Pizza',
            availability: 6,
            selected: true,
          ),
          CategoryListItem(
            categoryIcon: Icons.bug_report,
            categoryName: 'Pepperoni Pizza',
            availability: 6,
            selected: false,
          ),
          CategoryListItem(
            categoryIcon: Icons.bug_report,
            categoryName: 'Polo Pizza',
            availability: 6,
            selected: false,
          ),
          CategoryListItem(
            categoryIcon: Icons.bug_report,
            categoryName: 'Gourment Pizza',
            availability: 6,
            selected: false,
          ),
          CategoryListItem(
...
GestureDetector buildGestureDetector(
  ...
  return GestureDetector(
    ...
    child: Container(
      ...
      padding: EdgeInsets.all(15),
      decoration: BoxDecoration(
          color: Colors.red[300], borderRadius: BorderRadius.circular(50)),
    ),
  );
}
